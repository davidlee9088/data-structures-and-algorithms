...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let newArr = [];
  arr.map(element => newArr.push(Math.pow(element,3)))
  return newArr;
};
...
const addOne = (arr) => {
  // Solution code here...
  let newArr = [];
  arr.map(element => newArr.push(element + 1))
  return newArr;
...
const addQuestion = (arr) => {
  // Solution code here...
  let newArr = [];
  arr.map(element => newArr.push(element + '?'))
  return newArr;
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let newArr = [];
   arr.map(element => newArr.push(Math.pow(2,element)))
   return newArr;
};
